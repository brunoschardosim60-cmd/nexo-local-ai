...
export const ERROR_KINDS=Object.freeze(['TRANSIENT','AUTH','PERMISSION','INVALID_INPUT','NOT_FOUND','RATE_LIMIT','UNAVAILABLE','INTERNAL']);
...
export function capabilityError(kind,message,details={}){const error=new Error(message);error.kind=ERROR_KINDS.includes(kind)?kind:'INTERNAL';error.details=details;return error;}
