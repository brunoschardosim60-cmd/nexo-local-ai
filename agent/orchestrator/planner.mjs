    ...
    assigned === 'coding'
      ...
      : assigned === 'research'
        ...
        : assigned === 'browser'
          ...
          : assigned === 'workspace'
            ? [
                ['Verificar integração', 'Confirme que o servidor google-workspace está configurado e disponível usando mcp.servers.', 'workspace', { tool: 'mcp.servers', input: {} }],
                ['Descobrir ferramentas', 'Liste somente as tools Google Workspace autorizadas no servidor google-workspace.', 'workspace', { tool: 'mcp.tools', input: { serverId: 'google-workspace' } }],
                ['Executar ação Google', 'Escolha a tool descoberta compatível com o pedido. Leituras usam escopo mínimo; qualquer escrita deve aguardar confirmação explícita.', 'workspace'],
                ['Validar resultado', 'Confira a resposta estruturada do Google e não declare sucesso sem evidência retornada pela API.', 'workspace'],
              ]
          : [
              [
                'Entender o contexto',
